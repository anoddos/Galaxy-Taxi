...
public partial class Offices
{
	...
	private async Task AddMarker()
	{
		...
		await marker.AddListener("dragend", async () =>
		{
			...
			OfficeFilter.Address.Longitude = (decimal?)position.Lng;
			OfficeFilter.Address.Latitude = (decimal?)position.Lat;
	...
	private async Task OfficeValueChanged(OfficeInfo current)
	{
		...
		else
		{
			...
			mapOptions.Center = new LatLngLiteral { Lat = (double)OfficeFilter.Address.Latitude, Lng = (double)OfficeFilter.Address.Longitude };
		}
